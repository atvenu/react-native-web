...
_this2.styleManager.getDeclaration(className);var prop=_styleManager$getDecl.prop;var value=_styleManager$getDecl.value;
if(prop){
...
this.resolve([previousReactNativeStyle,reactNativeStyle]);var classList=_resolve.classList;var _resolve$style=_resolve.style;var style=_resolve$style===undefined?{}:_resolve$style;



classList.forEach(function(className){var _styleManager$getDecl2=
_this2.styleManager.getDeclaration(className);var prop=_styleManager$getDecl2.prop;
style[prop]=null;
});
