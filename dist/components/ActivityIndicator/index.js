...
this.props;var animating=_props.animating;var color=_props.color;var hidesWhenStopped=_props.hidesWhenStopped;var size=_props.size;var style=_props.style;var other=_objectWithoutProperties(_props,['animating','color','hidesWhenStopped','size','style']);

var svg=
_react2.default.createElement('svg',{height:'100%',viewBox:'0 0 32 32',width:'100%',__source:{fileName:_jsxFileName,lineNumber:36}},
...
style:{
stroke:color,
opacity:0.2},__source:{fileName:_jsxFileName,lineNumber:37}}),
...
stroke:color,
strokeDasharray:80,
strokeDashoffset:60},__source:{fileName:_jsxFileName,lineNumber:48}}));
...
'aria-valuemax':'1',
'aria-valuemin':'0',
style:[styles.container,style,typeof size==='number'&&{height:size,width:size}],__source:{fileName:_jsxFileName,lineNumber:64}}),
...
!animating&&hidesWhenStopped&&styles.hidesWhenStopped],__source:{fileName:_jsxFileName,lineNumber:71}})));
