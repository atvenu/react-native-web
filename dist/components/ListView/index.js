...
this.props;var dataSource=_props.dataSource;var enableEmptySections=_props.enableEmptySections;var renderFooter=_props.renderFooter;var renderHeader=_props.renderHeader;var renderScrollComponent=_props.renderScrollComponent;var renderSectionHeader=_props.renderSectionHeader;var renderSeparator=_props.renderSeparator;var initialListSize=_props.initialListSize;var onChangeVisibleRows=_props.onChangeVisibleRows;var onEndReached=_props.onEndReached;var onEndReachedThreshold=_props.onEndReachedThreshold;var onKeyboardDidHide=_props.onKeyboardDidHide;var onKeyboardDidShow=_props.onKeyboardDidShow;var onKeyboardWillHide=_props.onKeyboardWillHide;var onKeyboardWillShow=_props.onKeyboardWillShow;var pageSize=_props.pageSize;var renderRow=_props.renderRow;var scrollRenderAheadDistance=_props.scrollRenderAheadDistance;var stickyHeaderIndices=_props.stickyHeaderIndices;var scrollProps=_objectWithoutProperties(_props,['dataSource','enableEmptySections','renderFooter','renderHeader','renderScrollComponent','renderSectionHeader','renderSeparator','initialListSize','onChangeVisibleRows','onEndReached','onEndReachedThreshold','onKeyboardDidHide','onKeyboardDidShow','onKeyboardWillHide','onKeyboardWillShow','pageSize','renderRow','scrollRenderAheadDistance','stickyHeaderIndices']);
...
shouldUpdate:!!shouldUpdateHeader,__source:{fileName:_jsxFileName,lineNumber:180}}));
...
shouldUpdate:!!shouldUpdateRow,__source:{fileName:_jsxFileName,lineNumber:198}});
